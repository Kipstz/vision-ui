	...
	const tableau_boombox = [
		{
			...
			valeur: "POSER AU SOL",
			action: "poser",
			img: "https://cdn.visionrp.fr/vision-cdn-v1/Boombox/img_poser.webp",
		},
		{
			id: 1,
			valeur: "PORTER SUR L'ÉPAULE",
			action: "porter",
			img: "https://cdn.visionrp.fr/vision-cdn-v1/Boombox/img_porter.webp",
		},
		{
			id: 2,
			valeur: "RAMASSER",
			action: "ramasser",
			img: "https://cdn.visionrp.fr/vision-cdn-v1/Boombox/img_ramasser.webp",
		},
	];
			...
			<div className="Container_Boombox1">
				<div className="d-flex flex-auto flex-column">
					<div style={{ height: 102, display: "flex", width: "100%" }} id="bloc9">
						<img src="https://cdn.visionrp.fr/vision-cdn-v1/Boombox/header.webp" style={{ height: "100%", width: "100%" }} />
					</div>
