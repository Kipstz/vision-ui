...
const SpawnPoint: React.FC<Props> = ({ onBack }) => {
	...
	return (
		<div className="_colorPicker spawnPoint">
          ...
          <img src="https://cdn.visionrp.fr/vision-cdn-v1/CreationPersonnage/spawn.svg" />
        </div> */}
			</div>
			<div className="Cont">
				...
				<div className="SpawnList">
					{array.map((_e, i) => (
						<div className={"Spawn" + (s === _e ? " Selected" : "")} onClick={() => sS(_e)}>
							<img className="Img" src={`https://cdn.visionrp.fr/vision-cdn-v1/CreationPersonnage/${i + 1}.webp`}></img>
