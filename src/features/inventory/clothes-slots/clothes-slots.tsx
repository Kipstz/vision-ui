	...
	return (
		<div className="clothes-slots">
			<div
				...
				style={{ backgroundImage: props.clothes.hat ? "" : "url(https://cdn.visionrp.fr/vision-cdn-v1/inventory/hat.svg)" }}>
				{props.clothes.hat && (
					<div
						...
						style={{
							backgroundImage: props.clothes.hat?.url
								...
								: `url(https://cdn.visionrp.fr/vision-cdn-v1/inventory/items/${props.clothes.hat.name}.webp)`,
			...
			<div
				...
				onMouseLeave={() => props.setDropTo("")}
				style={{ backgroundImage: props.clothes.tshirt ? "" : "url(https://cdn.visionrp.fr/vision-cdn-v1/inventory/top.svg)" }}>
					...
					<div
						...
						style={{
							backgroundImage: props.clothes.tshirt?.url
								...
								: `url(https://cdn.visionrp.fr/vision-cdn-v1/inventory/items/${props.clothes.tshirt.name}.webp)`,
			...
			<div
				...
				onMouseLeave={() => props.setDropTo("")}
				style={{ backgroundImage: props.clothes.pant ? "" : "url(https://cdn.visionrp.fr/vision-cdn-v1/inventory/pants.svg)" }}>
				{props.clothes.pant && (
					<div
						className="item-image"
						style={{
							backgroundImage: props.clothes.pant?.url
								...
								: `url(https://cdn.visionrp.fr/vision-cdn-v1/inventory/items/${props.clothes.pant.name}.webp)`,
			...
			<div
				...
				onMouseLeave={() => props.setDropTo("")}
				style={{ backgroundImage: props.clothes.feet ? "" : "url(https://cdn.visionrp.fr/vision-cdn-v1/inventory/shoes.svg)" }}>
				{props.clothes.feet && (
					<div
						className="item-image"
						style={{
							backgroundImage: props.clothes.feet?.url
								...
								: `url(https://cdn.visionrp.fr/vision-cdn-v1/inventory/items/${props.clothes.feet.name}.webp)`,
			...
			<div
				...
				onMouseLeave={() => props.setDropTo("")}
				style={{
					backgroundImage: props.clothes.glasses ? "" : "url(https://cdn.visionrp.fr/vision-cdn-v1/inventory/glasses.svg)",
				}}>
					...
					<div
						...
						style={{
							backgroundImage: props.clothes.glasses?.url
								...
								: `url(https://cdn.visionrp.fr/vision-cdn-v1/inventory/items/${props.clothes.glasses.name}.webp)`,
			...
			<div
				...
				onMouseLeave={() => props.setDropTo("")}
				style={{ backgroundImage: props.clothes.access ? "" : "url(https://cdn.visionrp.fr/vision-cdn-v1/inventory/bag.svg)" }}>
					...
					<div
						...
						style={{
							backgroundImage: props.clothes.access?.url
								...
								: `url(https://cdn.visionrp.fr/vision-cdn-v1/inventory/items/${props.clothes.access.name}.webp)`,
