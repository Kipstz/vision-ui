		...
		<div className="deathscreen">
			...
			<div className="deathscreen_bottom">
				<div
					...
					style={{
						backgroundImage:
							"linear-gradient(90deg, rgba(6,6,6,0.12) 0%, rgba(170,0,0,0.52) 100%),url('https://cdn.visionrp.fr/vision-cdn-v1/deathscreen/background.webp')",
					}}>
					<img className="deathscreen_bottom_top_img" src="https://cdn.visionrp.fr/vision-cdn-v1/deathscreen/timer.webp" />
