						...
						<div
							...
							style={{
								backgroundImage: props.weapons[1].url
									...
									: `url(https://cdn.visionrp.fr/vision-cdn-v1/inventory/items/${props.weapons[1].name}.webp)`,
							}}
						...
						<div
							...
							style={{
								backgroundImage: props.weapons[2].url
									...
									: `url(https://cdn.visionrp.fr/vision-cdn-v1/inventory/items/${props.weapons[2].name}.webp)`,
							}}
						...
						<div
							...
							style={{
								backgroundImage: props.weapons[3].url
									...
									: `url(https://cdn.visionrp.fr/vision-cdn-v1/inventory/items/${props.weapons[3].name}.webp)`,
							}}
						...
						<div
							...
							style={{
								backgroundImage: props.weapons[4].url
									...
									: `url(https://cdn.visionrp.fr/vision-cdn-v1/inventory/items/${props.weapons[4].name}.webp)`,
							}}
						...
						<div
							...
							style={{
								backgroundImage: props.weapons[5].url
									...
									: `url(https://cdn.visionrp.fr/vision-cdn-v1/inventory/items/${props.weapons[5].name}.webp)`,
							}}
