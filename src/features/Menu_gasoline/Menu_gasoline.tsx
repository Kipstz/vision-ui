...
const Menu_gasoline: React.FC = () => {
	...
	const achatRapide_item = [
		{
			id: 0,
			prix: "20",
			image: "https://cdn.visionrp.fr/vision-cdn-v1/Vespucci/img_mask3.webp",
			name: "test",
			label: "",
		},
		{
			id: 1,
			prix: "198",
			image: "https://cdn.visionrp.fr/vision-cdn-v1/Vespucci/img_mask.webp",
			name: "test",
			label: "",
		},
		{
			id: 2,
			prix: "0",
			image: "https://cdn.visionrp.fr/vision-cdn-v1/Vespucci/img_mask2.webp",
			name: "test",
			label: "",
		},
	];
	...
	const catalogue_item = [
		{
			id: 3,
			image: "https://cdn.visionrp.fr/vision-cdn-v1/other/photo_haut_clothes.webp",
			name: "hauts",
		},
		{
			id: 4,
						...
						<div className="Container_gasoline">
							...
							<div style={{ display: "flex", height: 85, width: "100%", alignItems: "center" }}>
								<img
									...
									src="https://cdn.visionrp.fr/vision-cdn-v1/Gasoline/header.webp"
								/>
								<div
									style={{
										flex: "auto",
									...
									<img src="https://cdn.visionrp.fr/vision-cdn-v1/Gasoline/logo.webp" />
