...
const JobCenter: React.FC = () => {
	...
	const data = isDev
		? {
				headerIcon: "https://cdn.visionrp.fr/vision-cdn-v1/icons/image_homme.webp",
			...
			<div className="VisionMenu" style={{ width: 485, height: "fit-content" }}>
				<div className="VisionMenu-header">
					<img
						...
						onClick={() => returnCB()}
						src="https://cdn.visionrp.fr/vision-cdn-v1/headers/jobcenter.webp"
					/>
											...
											<>
												{job.premium && data.premium === 1 && (
													<>
														<p className="players">
															{job.maxPlayers || 4}
															<img width={18} src="https://cdn.visionrp.fr/vision-cdn-v1/svg/user.svg" />
														</p>

														<p className="dollar">{job.reward}</p>
														<p>
															{job.duration}&apos;{" "}
															<img width={16} src="https://cdn.visionrp.fr/vision-cdn-v1/icons/clock.webp" />
														</p>
													</>
												)}
							...
							<div className="infosContainer">
								<div className="stats">
									...
									<p>
										...
										<span>
											{job?.limit}{" "}
											<img width={20} src="https://cdn.visionrp.fr/vision-cdn-v1/icons/chevron_up.webp" />
										</span>
									</p>
									<p>
										Joueurs{" "}
										<span>
											{job?.maxPlayers || 4}{" "}
											<img width={24} src="https://cdn.visionrp.fr/vision-cdn-v1/svg/user.svg" />
										</span>
									</p>
								</div>
