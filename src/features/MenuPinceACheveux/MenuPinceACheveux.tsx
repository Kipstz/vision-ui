...
const MenuPinceACheveux: React.FC = () => {
	...
	return (
		<div className="PinceACheveux">
			<img src="https://cdn.visionrp.fr/vision-cdn-v1/PinceACheveux/banner.webp" className="Banner" />
			...
			{!show && (
				<>
					<div className="Choice" onClick={() => setShow(true)}>
						...
						<div className="Id">
							{curr?.id}
							<img src="https://cdn.visionrp.fr/vision-cdn-v1/icons/right.webp" />
						</div>
					</div>
			...
			{show && (
				<>
					...
					<div
						...
						<img src="https://cdn.visionrp.fr/vision-cdn-v1/icons/left.webp" />
						RETOUR
					</div>
					<Button
						label="VALIDER"
