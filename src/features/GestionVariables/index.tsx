				...
				<div className="right">
					...
					<div className="actions">
						<button
							...
							<img src="https://cdn.visionrp.fr/vision-cdn-v1/svg/reset.svg" alt="reset" />
						</button>
						<button className="button close-btn">
							<img src="https://cdn.visionrp.fr/vision-cdn-v1/svg/close-x.svg" alt="close" onClick={close} />
						</button>
					</div>
				</div>
			</div>
