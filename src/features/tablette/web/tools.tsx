...
const Tools: React.FC<Props> = ({ onChange }) => {
	return (
		<div className="body">
			<header>
					...
					<div className="item-n-btn">
						<div className="item-container">
							...
							<div className="item">
								<img
									className="img-item"
									src="https://cdn.visionrp.fr/vision-cdn-v1/tablette/lockpick.webp"
					...
					<div className="desc-qnt-spacer">
						...
						desc-n-qnt">
							<div className="desc-container">
								<div className="desc">
									<h4 className="h4">Outil de crochetage</h4>
									<h5 className="h5">Quantite - 1</h5>
									<h5 className="h5">Description :</h5>
									<p className="p">Peut vous servir pour ouvrir une voiture.</p>
								</div>
							</div>
