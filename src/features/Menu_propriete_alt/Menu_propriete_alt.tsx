				...
				<div className="Container_propriete">
					<div style={{ flex: "auto", display: "flex", flexDirection: "column" }}>
						<div style={{ height: 92, display: "flex", width: "100%" }}>
							<img
								src="https://cdn.visionrp.fr/vision-cdn-v1/Propriete/header2.webp"
								...
								<div style={{ height: 40, width: 45, position: "absolute", right: 30, top: 110 }}>
									<CircularProgressbarWithChildren
										...
										<div className="text_title">
											<img
												src={`https://cdn.visionrp.fr/vision-cdn-v1/Propriete/${data.isLocked ? "" : "un"}lock.webp`}
												style={{
													width: 14,
												}}
											/>
					...
					<div style={{ flex: "auto", padding: "5px 20px", display: "flex" }}>
						<div style={{ flex: "auto", flexDirection: "column", display: "flex", position: "relative" }}>
							<div style={{ flexDirection: "row", display: "flex", alignItems: "center", paddingTop: 10 }}>
								<img src="https://cdn.visionrp.fr/vision-cdn-v1/Propriete/mailbox.svg" style={{ width: 30 }} />
								<div style={{ width: 20 }} />
										...
										<div key={index}>
											{!canInput && (
												<div
													...
													<img
														src={"https://cdn.visionrp.fr/vision-cdn-v1/Propriete/carton.webp"}
														style={{
															width: 40,
															height: "auto",
														}}></img>
											...
											{canInput && (
												<div
													...
													<img
														src={"https://cdn.visionrp.fr/vision-cdn-v1/Propriete/add.webp"}
														style={{
															width: 30,
															height: "auto",
														}}></img>
