	...
	const catalogue = [
		{
			...
			availableColors: [
				{ value: "#AFFFFF", image: "https://cdn.visionrp.fr/vision-cdn-v1/Boutique/placeholder.webp" },
				{ value: "#BA0293", image: "https://cdn.visionrp.fr/vision-cdn-v1/Boutique/placeholder.webp" },
			],
			price: 3000,
					...
					<div className="ActiveCatContent">
						...
						<div className="Center">
							<div
								...
								<img src="https://cdn.visionrp.fr/vision-cdn-v1/icons/left.svg" />
							</div>
						...
						<div className="Nav">
							<div className="Left">
								<div className="Element">
									<img src="https://cdn.visionrp.fr/vision-cdn-v1/Boutique/vet.webp" className="Bg" />
								...
								<div
									...
									<img src="https://cdn.visionrp.fr/vision-cdn-v1/Boutique/bij.webp" className="Bg" />
									<div className="Name">BIJOUX</div>
									<div className="SubName">DE MARQUE</div>
								</div>
							</div>
							<div className="Element">
								<img src="https://cdn.visionrp.fr/vision-cdn-v1/Boutique/voit.webp" className="Bg" />
							...
							<div className="Element">
								<img src="https://cdn.visionrp.fr/vision-cdn-v1/Boutique/cus.webp" className="Bg" />
