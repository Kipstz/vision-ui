		...
		<div className="Peds">
			...
			<MenuField fieldName="SEXE">
				<div className="Selector">
					...
					<div
						...
						<img src="https://cdn.visionrp.fr/vision-cdn-v1/icons/right.svg" />
					</div>
				</div>
			</MenuField>
			...
			<div className="Submit">
				...
				<Button
					...
					<img height="17" width="17" src={"https://cdn.visionrp.fr/vision-cdn-v1/CreationPersonnage/confirm.svg"} alt="" />
				</Button>
			</div>
			{show && (
