...
const Inventory: React.FC = () => {
	...
	const [category, setCategory] = useState<InventoryCategory>(
		(sessionStorage.getItem("inventory_category") as InventoryCategory) || ("items" as InventoryCategory),
	);
						...
						<div className="inventory-main-container">
							<div className="inventory-target-header">
								...
								<div
									...
									style={{ backgroundImage: 'url("https://cdn.visionrp.fr/vision-cdn-v1/inventory/weight.svg")' }}>
