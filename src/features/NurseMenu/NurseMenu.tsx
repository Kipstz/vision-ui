	...
	return (
		<div id="NurseMenu">
			<div className="Banner">
				<img src="https://cdn.visionrp.fr/vision-cdn-v1/Menu/Nurse/NurseMenu.webp" />
			</div>

			<div className="Content">
				<div className="PatientTop">
					<img src="https://cdn.visionrp.fr/vision-cdn-v1/Menu/Nurse/NurseIcon.webp" />
					<div className="Info">
				...
				<div className="PatientButtons">
					<div className="Button">
						<div className="icon">
							<img src="https://cdn.visionrp.fr/vision-cdn-v1/Menu/Nurse/User.webp" />
						</div>
						<span>{data.birthdate}</span>
					</div>
					<div className="Button">
						<div className="icon">
							<img src="https://cdn.visionrp.fr/vision-cdn-v1/Menu/Nurse/Drop.webp" />
						</div>
