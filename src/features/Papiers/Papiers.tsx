...
const Papiers: React.FC = () => {
	...
	const data: any = isDev
		? {
				...
				overrideImage: "https://cdn.visionrp.fr/vision-cdn-v1/placeholder.webp",
			}
		: context.data;
				...
				<div
					...
					<div className="Receipt">
						...
						<label htmlFor={"receipt" + (data.state !== "creation" ? "ReadOnly" : "")}>
							<div className={"Label "}>
								<img
									src={`https://cdn.visionrp.fr/vision-cdn-v1/Papiers/${stockage["receipt"] ? "check" : "cross"}.webp`}
								/>
							</div>
						</label>
						<input
			...
			{data.type === "factureToEntreprise" && (
				<>
					<div
						...
						style={{
							backgroundImage: `url('https://cdn.visionrp.fr/vision-cdn-v1/Papiers/default.webp')`,
						}}></div>
					<div
						className="Content Anim A-FadeIn"
						style={{
			...
			{data.type === "deposition" && (
				<>
					<div
						className="Content Anim A-FadeIn"
						style={{
							backgroundImage: `url('https://cdn.visionrp.fr/vision-cdn-v1/Papiers/deposition.webp')`,
						}}></div>
					<div
						className="Content Anim A-FadeIn"
						style={{
					...
					<div
						...
						<img src={data.overrideImage ?? "https://cdn.visionrp.fr/vision-cdn-v1/Papiers/LSPD.svg"} className="Logo"></img>
						<div className="Title">
							DÉPOSITION
							{createInput(stockage?.["name"] ?? "", ev => updateStockage("name", ev.currentTarget.value))}
						</div>
			...
			{data.type === "certificat" && (
				<>
					<div
						className="Content Anim A-FadeIn"
						style={{
							backgroundImage: `url('https://cdn.visionrp.fr/vision-cdn-v1/Papiers/certificat.webp')`,
						}}></div>
					<div
						className="Content Anim A-FadeIn"
						style={{
					...
					<div
						...
						<img src={data.overrideImage ?? "https://cdn.visionrp.fr/vision-cdn-v1/Papiers/SAMS.svg"} className="Logo"></img>
						<div className="Title">
							CERTIFICAT MEDICAL
							<br />
							{createInput(stockage?.["name"] ?? "", ev => updateStockage("name", ev.currentTarget.value))}
			...
			{data.type === "policeBadge" && (
				<>
					...
					<div
						...
						<img src={"https://cdn.visionrp.fr/vision-cdn-v1/Papiers/911.webp"} className="Logo"></img>
			...
			{data.type === "PapierPPA" && (
				<>
					...
					<div
						...
						<img src={"https://cdn.visionrp.fr/vision-cdn-v1/Papiers/gouv.webp"} className="Logo" />
