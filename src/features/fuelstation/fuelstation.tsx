		...
		<div className="fuelstation">
			<FuelContainer title="Remplir le réservoir d'essence">
				<div className="fuelstation_row">
					<FuelButton icon="https://cdn.visionrp.fr/vision-cdn-v1/fuelstation/nozzle.webp" onClick={setMaxFuel}>
						Faire le plein
					</FuelButton>
			...
			<FuelContainer title="Procéder au paiement">
				<div className="fuelstation_row">
					<FuelButton icon="https://cdn.visionrp.fr/vision-cdn-v1/fuelstation/cash.webp" onClick={() => doPay(true)}>
						Payer en espèce
					</FuelButton>
					<FuelButton icon="https://cdn.visionrp.fr/vision-cdn-v1/fuelstation/card.webp" onClick={() => doPay(false)}>
						Payer par carte
					</FuelButton>
					<div className="fuelstation_label">
