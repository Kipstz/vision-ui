...
function CardNewsSocietyCreate() {
	...
	const data: any | null = isDev
		? {
				...
				logo_society: "https://cdn.visionrp.fr/vision-cdn-v1/other/logo_dynasti.webp",
				preset: "GOUV",
			}
	...
	if (data?.preset) {
		if (data?.preset === "LSPD") {
			label = "LSPD";
			number = 911;
			image = "https://cdn.visionrp.fr/vision-cdn-v1/vNotif/lspd.webp";
			type1 = "INTERVENTION";
			type2 = "INFORMATION";
			type3 = "ALERTE";
		}
		if (data?.preset === "LSFD") {
			label = "LSFD";
			number = 912;
			image = "https://cdn.visionrp.fr/vision-cdn-v1/vNotif/lsfd.webp";
			type1 = "INTERVENTION";
			type2 = "INFORMATION";
			type3 = "ALERTE";
		}
		if (data?.preset === "LSSD") {
			label = "LSSD";
			number = 913;
			image = "https://cdn.visionrp.fr/vision-cdn-v1/vNotif/lssd.webp";
			type1 = "INTERVENTION";
			type2 = "INFORMATION";
			type3 = "ALERTE";
		}
		if (data?.preset === "SAMS") {
			label = "SAMS";
			number = 914;
			image = "https://cdn.visionrp.fr/vision-cdn-v1/vNotif/SAMS.webp";
			type1 = "INTERVENTION";
			type2 = "INFORMATION";
			type3 = "ALERTE";
		}
		if (data?.preset === "USSS") {
			label = "USSS";
			number = null;
			image = "https://cdn.visionrp.fr/vision-cdn-v1/vNotif/usss.webp";
			type1 = "INTERVENTION";
			type2 = "INFORMATION";
			type3 = "ALERTE";
		}
		if (data?.preset === "G6") {
			label = "G6";
			number = 914;
			image = "https://cdn.visionrp.fr/vision-cdn-v1/vNotif/g6.webp";
			type1 = "SECURISATION";
			type2 = "INFORMATION";
			type3 = "ALERTE";
		}
		if (data?.preset === "GOUV") {
			label = "GOUVERNEMENT";
			number = null;
			image = "https://cdn.visionrp.fr/vision-cdn-v1/vNotif/gouv.webp";
			type1 = "INTERVENTION";
			type2 = "INFORMATION";
			type3 = "ALERTE";
		}
		if (data?.preset === "JUSTICE") {
			label = "JUSTICE";
			number = null;
			image = "https://cdn.visionrp.fr/vision-cdn-v1/vNotif/justice.webp";
			type1 = "INTERVENTION";
			type2 = "INFORMATION";
			type3 = "ALERTE";
		}
			...
			<div style={{ display: "flex", flex: 1, backgroundColor: "transparent" }}>
				<div className={"Container_NotifEntrepriseV2 " + (data?.preset ?? "")}>
					<div style={{ height: 80, display: "flex", width: "100%" }} id="bloc1">
						<img
							src="https://cdn.visionrp.fr/vision-cdn-v1/other/header_createWeazel.webp"
