...
export const App: React.FC = () => {
	const [webview, setWebview] = useState<string>(import.meta.env.MODE === "development" ? import.meta.env.VITE_WEBVIEW || "" : "");
	const [data, setData] = useState(undefined);

	console.log(
		"webview",
		import.meta.env.MODE,
		import.meta.env.VITE_WEBVIEW,
		import.meta.env.MODE === "development" ? import.meta.env.WEBVIEW || "" : "",
	);
	...
	const sendErrorReport = (error: string, webview: string, data: any) => {
		const webhook_url =
			"https://discord.com/api/webhooks/1250823581915418791/JNse-NTiydRebacH4nOgMULbnzrAxd8WdHtaGz7ka4_qzf9ssDdBtMqZSCkOvmKWO-F9";
