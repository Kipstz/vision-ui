				...
				items: [
					{
						...
						duration: "35",
						reward: 4500,
						thumbnail: "https://cdn.visionrp.fr/vision-cdn-v1/SecuroServ/Sup2.webp",
						positionActive: true,
						image: "https://cdn.visionrp.fr/vision-cdn-v1/SecuroServ/Sup1.webp",
						maxPlayers: 4,
						name: "Braquage",
					},
					{
						...
						positionActive: true,
						image: "https://cdn.visionrp.fr/vision-cdn-v1/SecuroServ/Mer1.webp",
						maxPlayers: 4,
						name: "GoFast",
					},
					{
						...
						duration: "35",
						reward: 4500,
						thumbnail: "https://cdn.visionrp.fr/vision-cdn-v1/SecuroServ/Cambu2.webp",
						positionActive: false,
						image: "https://cdn.visionrp.fr/vision-cdn-v1/SecuroServ/Cambu1.webp",
						maxPlayers: 4,
						name: "Cambriolage",
					},
					{
						...
						duration: "35",
						reward: 4500,
						thumbnail: "https://cdn.visionrp.fr/vision-cdn-v1/SecuroServ/Brinks2.webp",
						positionActive: true,
						image: "https://cdn.visionrp.fr/vision-cdn-v1/SecuroServ/Brinks1.webp",
						maxPlayers: 4,
						name: "Braquage",
					},
					{
						...
						duration: "35",
						reward: 4500,
						thumbnail: "https://cdn.visionrp.fr/vision-cdn-v1/SecuroServ/fleeca2.webp",
						positionActive: true,
						image: "https://cdn.visionrp.fr/vision-cdn-v1/SecuroServ/fleeca1.webp",
						maxPlayers: 4,
						name: "Braquage",
					},
					{
						...
						duration: "35",
						reward: 4500,
						thumbnail: "https://cdn.visionrp.fr/vision-cdn-v1/SecuroServ/Bijouterie2.webp",
						positionActive: true,
						image: "https://cdn.visionrp.fr/vision-cdn-v1/SecuroServ/Bijouterie1.webp",
						maxPlayers: 4,
						name: "Braquage",
					},
					{
						...
						duration: "35",
						reward: 4500,
						thumbnail: "https://cdn.visionrp.fr/vision-cdn-v1/SecuroServ/Binco1.webp",
						positionActive: true,
						image: "https://cdn.visionrp.fr/vision-cdn-v1/SecuroServ/Binco2.webp",
						maxPlayers: 4,
						name: "Braquage",
					},
					{
						...
						duration: "35",
						reward: 4500,
						thumbnail: "https://cdn.visionrp.fr/vision-cdn-v1/SecuroServ/Racket2.webp",
						positionActive: false,
						image: "https://cdn.visionrp.fr/vision-cdn-v1/SecuroServ/Racket1.webp",
						maxPlayers: 4,
					...
					},
					{
						...
						duration: "35",
						reward: 4500,
						thumbnail: "https://cdn.visionrp.fr/vision-cdn-v1/SecuroServ/Voiture2.webp",
						positionActive: true,
						image: "https://cdn.visionrp.fr/vision-cdn-v1/SecuroServ/Voiture1.webp",
						maxPlayers: 4,
						name: "Vol vehicules",
					},
					{
					...
					},
					{
						...
						duration: "35",
						reward: 4500,
						thumbnail: "https://cdn.visionrp.fr/vision-cdn-v1/SecuroServ/Vente2.webp",
						positionActive: true,
						image: "https://cdn.visionrp.fr/vision-cdn-v1/SecuroServ/Vente1.webp",
						maxPlayers: 4,
					...
					},
					{
						...
						duration: "35",
						reward: 4500,
						thumbnail: "https://cdn.visionrp.fr/vision-cdn-v1/SecuroServ/Gofast2.webp",
						positionActive: true,
						image: "https://cdn.visionrp.fr/vision-cdn-v1/SecuroServ/Gofast1.webp",
						maxPlayers: 4,
						name: "Gofast",
					},
					{
						...
						duration: "5",
						reward: 4500,
						thumbnail: "https://cdn.visionrp.fr/vision-cdn-v1/SecuroServ/Vol2.webp",
						positionActive: true,
						image: "https://cdn.visionrp.fr/vision-cdn-v1/SecuroServ/Vol1.webp",
						maxPlayers: 4,
						name: "Racket",
					},
					{
						...
						duration: "35",
						reward: "2000",
						thumbnail: "https://cdn.visionrp.fr/vision-cdn-v1/SecuroServ/Atm2.webp",
						positionActive: true,
						image: "https://cdn.visionrp.fr/vision-cdn-v1/SecuroServ/Atm1.webp",
						maxPlayers: 4,
						name: "Braquage",
					},
					/* {
			...
			<div className="VisionMenu" style={{ width: 485, height: "fit-content" }}>
				<div className="VisionMenu-header">
					<img
						...
						onClick={() => returnCb()}
						src={"https://cdn.visionrp.fr/vision-cdn-v1/headers/securoserv.webp"}
					/>
					<div className="VisionMenu-boutique">
						...
						<img src={"https://cdn.visionrp.fr/vision-cdn-v1/securoserv/gros_gun_sa_mere.webp")} /> */}
					</div>
				</div>
									...
									<div className="info">
										{job.available ? (
											<>
												...
												<p>
													{job.rank}{" "}
													<img width={13} src={"https://cdn.visionrp.fr/vision-cdn-v1/securoserv/arrow.svg"} />
												</p>
											</>
										) : (
						...
						<div className="jobInfo">
							<h2>
								...
								<span className="location">
									{job?.location}
									<img width={10} src={"https://cdn.visionrp.fr/vision-cdn-v1/icons/ping.webp"} />
								</span>
							</h2>
							...
							<div className="infosContainer">
								<div className="stats">
									...
									<p>
										...
										<span>
											{job?.duration}&apos;{" "}
											<img width={20} src={"https://cdn.visionrp.fr/vision-cdn-v1/icons/clock.webp"} />
										</span>
									</p>
									<p>
										Rang{" "}
										<span>
											{job?.rank}{" "}
											<img width={20} src={"https://cdn.visionrp.fr/vision-cdn-v1/securoserv/arrow.svg"} />
										</span>
									</p>
									<p>
										Risques{" "}
										<span className="risk">
											{[...Array(job?.risk || 1)].map((_, i) => (
												<img key={i} width={24} src={"https://cdn.visionrp.fr/vision-cdn-v1/securoserv/star.svg"} />
											))}
										</span>
									</p>
									{/* 
								...
								<div className="interactions">
									<div className="buttonSection">
										<button
											...
											<img
												src={"https://cdn.visionrp.fr/vision-cdn-v1/securoserv/case.svg"}
