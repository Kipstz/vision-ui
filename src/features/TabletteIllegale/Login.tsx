	...
	return (
		<>
			<ReactSVG
				...
				src={"https://cdn.visionrp.fr/vision-cdn-v1/TabletteIllegale/empreinte.svg"}
			/>
			<div className="span inser">{!isLogged ? "authentification..." : "authentification réussie"}</div>

			{isLogged ? (
				<div className="checkmark">
					<img src="https://cdn.visionrp.fr/vision-cdn-v1/TabletteIllegale/checkmark_yellow.webp" />
				</div>
			) : (
