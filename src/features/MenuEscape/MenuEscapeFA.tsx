...
const MenuEscapeFA: React.FC = () => {
	...
	return (
		<div className="MenuEscape" style={{ textTransform: "uppercase" }}>
			<BoutiqueHeader data={data} server="FA" />
					...
					<div className="Bottom">
						...
						{isSupportOpen ? (
							<div className="SupportReport" onClick={handleSupport}>
								<h2>
									<img src="https://cdn.visionrp.fr/vision-cdn-v1/icons/logo-v.webp" />
									Motif du report
								</h2>
								<textarea
									value={report}
								...
								/>
								{isErrorShown && <div className="Error">Merci de détailler votre report.</div>}
								<div>
									<div>Valider</div>
