...
const CardNewsSocietyShow: React.FC = () => {
	...
	const data: INotifEntreprise | null = isDev
		? {
				name: "Ammunation",
				logo: "https://cdn.visionrp.fr/vision-cdn-v1/other/logo_dynasti.webp",
				phone: "4321",
		...
		<div className="showAnnonce">
			<div className="main">
				...
				<div className="infos">
					...
					<img className="phonelogo" src="https://cdn.visionrp.fr/vision-cdn-v1/icons/green-phone.webp"></img>
				</div>
			</div>
