				...
				catalogue: [
					...
					},
					{
						...
						availableColors: [
							{
								value: "#AFFFFF",
								image: "https://cdn.visionrp.fr/vision-cdn-v1/Boutique/placeholder.webp",
		...
		<div className="BoutiqueWL">
			...
			<div className="main">
				...
				<div className="cards">
					<div
						className="card"
						style={{ backgroundImage: `url("https://cdn.visionrp.fr/vision-cdn-v1/Boutique/Sub1.webp")` }}
						onClick={() => {
					...
					<div
						className="card"
						style={{ backgroundImage: `url("https://cdn.visionrp.fr/vision-cdn-v1/Boutique/Sub2.webp")` }}
						onClick={() => {
					...
					<div
						...
						style={{ backgroundImage: `url("https://cdn.visionrp.fr/vision-cdn-v1/Boutique/veh_disbaled_wl.webp")` }}
						// onClick={() => {
						// 	postAsync("BoutiqueCategory", { button: "VehiculesBoutique", sex });
						// 	playBoutiqueEnter();
						// }}
					></div>
					{/* Ancienne image https://cdn.visionrp.fr/vision-cdn-v1/Boutique/veh.png?format=webp*/}
				</div>
			</div>
