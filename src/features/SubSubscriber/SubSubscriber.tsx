	...
	const features = [
		{
			...
			icon: "https://cdn.visionrp.fr/vision-cdn-v1/SubPremium/icons/up_arrows.webp",
			iconSize: "40px",
			text: "Menu Connexion",
		...
		},
		{
			...
			icon: "https://cdn.visionrp.fr/vision-cdn-v1/SubPremium/icons/code.webp",
			iconSize: "50px",
			text: "Accès discord",
		...
		},
		{
			...
			icon: "https://cdn.visionrp.fr/vision-cdn-v1/SubPremium/icons/plant.webp",
			iconSize: "40px",
			text: "Menu props",
		...
		},
		{
			...
			icon: "https://cdn.visionrp.fr/vision-cdn-v1/SubPremium/icons/group.webp",
			iconSize: "40px",
		...
		},
		{
			...
			icon: "https://cdn.visionrp.fr/vision-cdn-v1/SubPremium/icons/github.webp",
			iconSize: "60px",
			text: "Menu Animal",
			text2: "Sous dossier",
	...
	return (
		<>
			...
			<section
				...
				style={{ backgroundImage: `url("https://cdn.visionrp.fr/vision-cdn-v1/SubSubscriber/${background}.webp")` }}>
				...
				<div className="Content">
					...
					<div className="vehicle">
						<div className="card" onClick={() => postAsync("openCustomBoutique")}>
							<div className="icon">
								<img src={"https://cdn.visionrp.fr/vision-cdn-v1/SubSubscriber/vehicle.webp"} alt="" />
							</div>
							<div className="content">
								<div className="features">
