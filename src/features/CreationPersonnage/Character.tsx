		...
		<div className="character__wrapper">
				...
				<div className="flexDiv">
					<div className="parents__wrapper">
						<img
							src={
								p1
									? `https://cdn.visionrp.fr/vision-cdn-v1/parents/${parentList.find((p, i) => i + 1 === p1)?.image}.webp`
									: ""
							}
							alt=""
						/>
						<img
							src={
								p2
									? `https://cdn.visionrp.fr/vision-cdn-v1/parents/${parentList.find((p, i) => i + 1 === p2)?.image}.webp`
									: ""
							}
							alt=""
						/>
			...
			<MenuField className="characters__wrapper">
				<div
					...
					<img src="https://cdn.visionrp.fr/vision-cdn-v1/CreationPersonnage/next.svg" style={{ rotate: "180deg" }} />
				</div>
				...
				<div className="chars__int__wrapper">
					{parentList.slice((page - 1) * 4, page * 4).map((_parent, index) => (
						<div
							...
							<img src={`https://cdn.visionrp.fr/vision-cdn-v1/parents/${_parent.image}.webp`} alt="" />
							<span className="character__name">
								{(c === "parent1" ? p1 : p2) === index + 1 + page * 4 - 4 ? (
									<img src={"https://cdn.visionrp.fr/vision-cdn-v1/CreationPersonnage/confirm.svg"} alt="" />
								) : (
									<>{_parent.name}</>
								)}
							</span>
				...
				<div
					...
					<img src="https://cdn.visionrp.fr/vision-cdn-v1/CreationPersonnage/next.svg" />
				</div>
			</MenuField>
