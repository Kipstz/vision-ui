		...
		<div id="ascenseur">
			...
			<div className="buttons">
				...
				<div
					...
					<Button borderColor="#32c45a" icon="https://cdn.visionrp.fr/vision-cdn-v1/icons/bouton_vert.webp?zoom=125" />
					<Button borderColor="#d9392c" icon="https://cdn.visionrp.fr/vision-cdn-v1/icons/bouton_rouge.webp?zoom=125" />
					<Button borderColor="#529098" icon="https://cdn.visionrp.fr/vision-cdn-v1/icons/bouton_bleu.webp?zoom=125" />
				</div>
				...
				<div
					...
					<img style={{ height: 90 }} src="https://cdn.visionrp.fr/vision-cdn-v1/icons/grille.webp" />
				</div>
			</div>
		</div>
	);
