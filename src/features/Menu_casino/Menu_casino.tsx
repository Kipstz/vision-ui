				...
				<div className="Container_casino">
					<div style={{ display: "flex", flexDirection: "column" }}>
						<div style={{ height: 80, display: "flex", width: "100%" }}>
							<img
								src={"https://cdn.visionrp.fr/vision-cdn-v1/casino/banner.webp"}
										...
										return (
											<div key={index} className={"access"}>
												...
												<img
													src={
														data.premium
															? "https://cdn.visionrp.fr/vision-cdn-v1/casino/check.webp"
															: "https://cdn.visionrp.fr/vision-cdn-v1/casino/lock.webp"
													}
												/>
											</div>
										);
