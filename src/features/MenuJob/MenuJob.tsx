...
const MenuJob: React.FC = () => {
	...
	const data: any = isDev
		? {
				headerBanner: "https://cdn.visionrp.fr/vision-cdn-v1/MenuJob/ferme.webp",
				choice: {
					...
					choices: [
						{
							id: 1,
							label: "Plantation",
							img: "https://cdn.visionrp.fr/vision-cdn-v1/MenuJob/tractor.webp",
						},
						{
							id: 2,
							label: "Récolte",
							img: "https://cdn.visionrp.fr/vision-cdn-v1/MenuJob/trailer_1.webp",
						},
						{
							id: 3,
							label: "Transport",
							img: "https://cdn.visionrp.fr/vision-cdn-v1/MenuJob/trailer_2.webp",
						},
					],
				},
