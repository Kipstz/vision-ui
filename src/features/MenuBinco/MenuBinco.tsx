...
const MenuBinco: React.FC = () => {
	...
	const [catalogue, setCatalogue] = useState([
...

		{
			id: 10,
			price: 20,
			image: "https://assets-vision-fa.cdn.purplemaze.net/https://cdn.visionrp.fr/vision-cdn-v1/Binco/Homme/Hauts/20_1.webp",
			category: "Hauts",
			subCategory: "Hauts",
			//idVariation: null,
			isPremium: false,
		...
		},
		{
			label: "Variation N°2",
			subCategory: "Variations",
			image: "https://assets-vision-fa.cdn.purplemaze.net/https://cdn.visionrp.fr/vision-cdn-v1/Binco/Homme/Hauts/20_2.webp",
			targetId: 10,
			id: 11,
			category: "Hauts",
			isPremium: false,
		...
		},
		{
			label: "Variation N°2",
			subCategory: "Variations",
			image: "https://assets-vision-fa.cdn.purplemaze.net/https://cdn.visionrp.fr/vision-cdn-v1/Binco/Homme/Hauts/20_3.webp",
			targetId: 10,
			id: 11,
			category: "Hauts",
			isPremium: false,
			...
			{button && show === "main" && (
				<div className="setName">
					<Button
						...
						color="green"
						height={30}>
						<img height="15" width="15" src={"https://cdn.visionrp.fr/vision-cdn-v1/CreationPersonnage/confirm.svg"} alt="" />
					</Button>
				</div>
			)}
			{show !== "finalSubmit" && (
