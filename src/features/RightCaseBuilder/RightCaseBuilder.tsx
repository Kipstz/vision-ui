...
const RightCaseBuilder = () => {
	...
	const data: any | null = isDev
		? {
				...
				headerIcon: "/https://cdn.visionrp.fr/vision-cdn-v1/RightCaseBuilder/info.webp",
				items: [
					{
						icon: "/https://cdn.visionrp.fr/vision-cdn-v1/RightCaseBuilder/run.webp",
						title: "Suivre",
						action: "zizifesseyummy",
					},
					{
						icon: "/https://cdn.visionrp.fr/vision-cdn-v1/RightCaseBuilder/triangle.webp",
						title: "attaquer",
