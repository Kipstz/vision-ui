	...
	return (
		<div className="laboratoires">
			<div className="header">
				<img style={{ width: 492 }} src="https://cdn.visionrp.fr/vision-cdn-v1/headers/laboratoires.webp" />
			</div>
			...
			<div className="container">
				<div className="state">
					<div style={{ display: "flex", flexDirection: "row", alignItems: "center", marginBottom: 15 }}>
						...
						{state.state == 0 && (
							<img style={{ height: 20, marginLeft: 8 }} src="https://cdn.visionrp.fr/vision-cdn-v1/labo/inactif.webp" />
						)}
						{state.state == 1 && (
							<img style={{ height: 20, marginLeft: 8 }} src="https://cdn.visionrp.fr/vision-cdn-v1/labo/actif.webp" />
						)}
						{state.state == 2 && (
							<img style={{ height: 20, marginLeft: 8 }} src="https://cdn.visionrp.fr/vision-cdn-v1/labo/terminer.webp" />
						)}
					</div>
								...
								<div className="quantity-container">
									<div
										...
										<div
											...
											style={{
												height: 90,
												backgroundImage: `url(https://cdn.visionrp.fr/vision-cdn-v1/inventory/items/${state.image}.webp)`,
											}}
										/>
