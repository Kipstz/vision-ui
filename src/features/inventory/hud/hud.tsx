...
const InventoryHud: React.FC<IInventoryHudProps> = props => {
	...
	return (
		<div className="inventory-hud">
			<div className="hud-item" style={{ backgroundImage: 'url("https://cdn.visionrp.fr/vision-cdn-v1/inventory/thirst.webp")' }}>
			...
			<div className="hud-item" style={{ backgroundImage: 'url("https://cdn.visionrp.fr/vision-cdn-v1/inventory/hunger.webp")' }}>
				<svg height="60" width="60">
			...
			<div
				className="hud-item"
				style={{ backgroundImage: !weightHover && 'url("https://cdn.visionrp.fr/vision-cdn-v1/inventory/backpack.webp")' }}
