				...
				catalogue: [
					{
						id: 1,
						category: "hair",
						img: "https://cdn.visionrp.fr/vision-cdn-v1/placeholder.webp",
						label: "test",
					},
					{
						id: 1,
					...
					},
					{
						id: 0,
						price: 20,
						image: "https://cdn.visionrp.fr/vision-cdn-v1/Binco/Hauts/0.webp",
						category: "haut",
						subCategory: "haut",
					},
					{
				...
				buttons: [
					{
						...
						width: "full",
						image: "https://cdn.visionrp.fr/vision-cdn-v1/svg/tshirt.svg",
					...
					},
					{
						...
						width: "full",
						image: "https://cdn.visionrp.fr/vision-cdn-v1/svg/jeans.svg",
					...
					},
					{
						...
						width: "full",
						image: "https://cdn.visionrp.fr/vision-cdn-v1/svg/shoe.svg",
					...
					},
					{
						...
						width: "half",
						image: "https://cdn.visionrp.fr/vision-cdn-v1/svg/hat.svg",
						hoverStyle: "fill-black stroke-black",
					},
					{
						name: "autres",
						...
						width: "half",
						image: "https://cdn.visionrp.fr/vision-cdn-v1/svg/bouton.svg",
			...
			<div className={"CreationPersonnage " + (isClicking ? " selected" : "")} onMouseUp={() => setIsClicking(false)}>
				...
				<div className="cameras__wrapper">
					<div
						...
						<img src={"https://cdn.visionrp.fr/vision-cdn-v1/CreationPersonnage/camera3.svg"} alt="" />
					</div>
					...
					<div
						...
						<img src={"https://cdn.visionrp.fr/vision-cdn-v1/CreationPersonnage/eye.svg"} alt="" />
					</div>
					...
					<div
						...
						<img src={"https://cdn.visionrp.fr/vision-cdn-v1/CreationPersonnage/camera2.svg"} alt="" />
					</div>
				...
				<div className="menu">
					<header className="menu__header">
						<img src={"https://cdn.visionrp.fr/vision-cdn-v1/CreationPersonnage/header.jpg"} alt="" />
					</header>
					...
					<nav className={"menu__navigation " + (hidden || hidden2 ? "hidden" : "")}>
						<div
							...
							<div className="polygon">
								<img src={"https://cdn.visionrp.fr/vision-cdn-v1/CreationPersonnage/print.svg"} alt="finger p" />
							</div>
						...
						<div
							...
							<div className="polygon">
								<img src={"https://cdn.visionrp.fr/vision-cdn-v1/CreationPersonnage/user.svg"} alt="finger p" />
							</div>
						...
						<div
							...
							<div className="polygon">
								<img src={"https://cdn.visionrp.fr/vision-cdn-v1/CreationPersonnage/eye.svg"} alt="finger p" />
							</div>
						...
						<div
							...
							<div className="polygon">
								<img
									...
									src={"https://cdn.visionrp.fr/vision-cdn-v1/CreationPersonnage/apparence.svg"}
									alt="finger p"
								/>
							</div>
						...
						<div
							...
							<div className="polygon">
								<img
									style={{ height: 22 }}
									src={"https://cdn.visionrp.fr/vision-cdn-v1/CreationPersonnage/shirt.svg"}
									alt="finger p"
								/>
							</div>
					...
					<div className={"menu__interactions " + (hidden || hidden2 ? "hidden" : "")}>
						...
						<Button
							...
							<img
								height="17"
								width="17"
								src={"https://cdn.visionrp.fr/vision-cdn-v1/CreationPersonnage/confirm.svg"}
								alt=""
							/>
						</Button>
					</div>
