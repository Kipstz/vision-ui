...
const MenuPostOp: React.FC = () => {
	...
	const data: any = isDev
		? {
				headerImage: "https://cdn.visionrp.fr/vision-cdn-v1/MenuPostOp/header.webp",
				orders: [
					{
						id: 1,
						state: "awaiting",
						from: "BURGER SHOT",
						phone: "555-4592",
						icon: "https://cdn.visionrp.fr/vision-cdn-v1/MenuPostOp/food.webp",
						content: [
							{
								id: 1,
								name: "Burger du bled",
								...
								<div
									...
									<div className="OrderLine">
										...
										<div className="Buttons" style={_open ? { marginLeft: 10, marginTop: 4 } : {}}>
											<img
												src="https://cdn.visionrp.fr/vision-cdn-v1/MenuPostOp/arrow.webp"
												className="Arrow"
												style={
													_open
														? {
