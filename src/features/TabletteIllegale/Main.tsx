...
const TabletteMain: React.FC<any> = ({ _changePage, data }) => {
	const levels = [
		// {
		//     name: 'TERRITOIRE',
		//     image: 'https://cdn.visionrp.fr/vision-cdn-v1/TabletteIllegale/territory.svg',
		//     id: 'territory'
		// },
		// {
		//     name: 'DOUBLE BUSINESS',
		//     image: 'https://cdn.visionrp.fr/vision-cdn-v1/TabletteIllegale/doubleBusiness.svg',
		//     id: 'doubleBusiness'
		// },
		// {
		//     name: 'PRODUCTEUR',
		//     image: 'https://cdn.visionrp.fr/vision-cdn-v1/TabletteIllegale/production.svg',
		//     id: 'production'
		// },
		// {
		//     name: 'TRAFIC D\'ARMES',
		//     image: 'https://cdn.visionrp.fr/vision-cdn-v1/TabletteIllegale/weaponTrafic.svg',
		//     id: 'weaponTrafic'
		// },
		{
			name: "TERRITOIRE",
		...
		{
			name: "LABORATOIRE",
			image: "https://cdn.visionrp.fr/vision-cdn-v1/TabletteIllegale/laboratory.svg",
			id: "laboratory",
		},
		// {
		//     name: 'COMMANDE',
		//     image: 'https://cdn.visionrp.fr/vision-cdn-v1/TabletteIllegale/PANIER.svg',
		//     id: 'command'
		// },
		{
			name: "DOUBLE BUSINESS",
		...
		{
			name: "ACCELERATION",
			image: "https://cdn.visionrp.fr/vision-cdn-v1/TabletteIllegale/SABLIER.svg",
			id: "upgrade",
		},
	];
		...
		<>
			<div className="Content">
				<div
					...
					<div className="Up">
						<div className="Logo">
							<img src="https://cdn.visionrp.fr/vision-cdn-v1/TabletteIllegale/profile.webp" />
						</div>
				...
				<div
					...
					<div className="Logo">
						...
						<img src="https://cdn.visionrp.fr/vision-cdn-v1/TabletteIllegale/calendar.webp" />
					</div>
				...
				<div
					...
					<div className="CrewGeneral">
						<div className="Logo">
							<img src="https://cdn.visionrp.fr/vision-cdn-v1/TabletteIllegale/levelup.webp" />
						</div>
						<div className="Span">
							Rang de Crew
