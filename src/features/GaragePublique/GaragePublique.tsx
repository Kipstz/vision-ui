...
//https://assets-vision-fa.cdn.purplemaze.net/https://cdn.visionrp.fr/vision-cdn-v1/Concessionnaire/Voiture/%22..v.name..%22.webp
		...
		pound: [
			{
				id: 1,
				price: 0,
				image: "https://assets-vision-fa.cdn.purplemaze.net/https://cdn.visionrp.fr/vision-cdn-v1/Concessionnaire/Voiture/jugular.webp",
				name: "jugular",
		...
		<div className="GaragePublique" style={{ width: 490, height: 600 }}>
			{(!data.garageType || data.garageType === "voiture") && (
				<div className="GaragePublique-header">
					<img className="GaragePublique-headerImage" src={"https://cdn.visionrp.fr/vision-cdn-v1/GaragePublique/header.webp"} />
					<div className="GaragePublique-boutique">
						<img src={"https://cdn.visionrp.fr/vision-cdn-v1/GaragePublique/car_icon.webp"} />
						<span>Voitures</span>
					</div>
				</div>
			)}
			...
			{data.garageType === "bateau" && (
				<div className="GaragePublique-header">
					<img className="GaragePublique-headerImage" src={"https://cdn.visionrp.fr/vision-cdn-v1/GaragePublique/header2.webp"} />
					<div className="GaragePublique-boutique">
						<img src={"https://cdn.visionrp.fr/vision-cdn-v1/GaragePublique/ship_icon.webp"} />
						<span>Bateaux</span>
					</div>
				</div>
			)}
