...
const SubPremiumPlus: React.FC<any> = () => {
	...
	const features = [
		...
		{
			name: "Casino",
			icon: "https://media.discordapp.net/attachments/1224862931775131669/1229456158843211867/icon__Santiment_Network_Token_Cryptocurrency_.webp?ex=662fbf46&is=661d4a46&hm=1da3330f10d7de23f26be1451e8266400910b91ec8b9cec4cce66d42a6b79451&=&format=webp&quality=lossless",
			text: "Menu Connexion",
	...
	return (
		<div style={{ width: "100%", height: "100%" }}>
			...
			<section className="SubPremiumPlus">
				<div className="header">
					...
					<div className="right">
						<h1>
							5000 <img src="https://cdn.visionrp.fr/vision-cdn-v1/icons/logo.webp" alt="logo" />
						</h1>
						<p>VCOINS OFFERTS PAR MOIS</p>
					</div>
				</div>
				<div className="content">
					<div className="features">
						<div className="left">
							<div className="feature">
								<div className="icon">
									<img src={"https://cdn.visionrp.fr/vision-cdn-v1/SubPremium/icons/dollars.webp"} alt="" />
								</div>
								<div className="content">
									<h3>
										Salaire X <b>2</b>
							...
							<div className="feature">
								<div className="icon">
									<img src={"https://cdn.visionrp.fr/vision-cdn-v1/SubPremium/icons/players.webp"} alt="" />
								</div>
								<div className="content">
							...
							<div className="feature">
								<div className="icon">
									<img src={"https://cdn.visionrp.fr/vision-cdn-v1/SubPremium/icons/chairs.webp"} alt="" />
								</div>
								<div className="content">
							...
							<div className="feature">
								<div className="icon">
									<img src={"https://cdn.visionrp.fr/vision-cdn-v1/SubPremium/icons/ped.webp"} alt="" />
								</div>
								<div className="content">
							...
							<div className="feature">
								<div className="icon">
									<img src={"https://cdn.visionrp.fr/vision-cdn-v1/SubPremium/icons/car.webp"} alt="" />
								</div>
								<div className="content">
							...
							<div className="feature">
								<div className="icon">
									<img src={"https://cdn.visionrp.fr/vision-cdn-v1/SubPremium/icons/casino-chip.webp"} alt="" />
								</div>
								<div className="content">
									<h3>Casino</h3>
									<p style={{ background: "linear-gradient(180deg, #FF005F 0%, #F09 100%)" }}>Accès VIP</p>
								</div>
							</div>
						</div>
						<div className="right">
							<div className="feature">
								<div className="icon">
									<img
										src={"https://cdn.visionrp.fr/vision-cdn-v1/SubPremium/icons/red_mark.webp"}
										alt=""
										style={{ width: "35px" }}
									/>
								</div>
							...
							<div className="feature">
								<div className="icon">
									<img src={"https://cdn.visionrp.fr/vision-cdn-v1/SubPremium/icons/dogs.webp"} alt="" />
								</div>
								<div className="content">
							...
							<div className="feature">
								<div className="icon">
									<img src={"https://cdn.visionrp.fr/vision-cdn-v1/SubPremium/icons/fingerprint.webp"} alt="" />
								</div>
								<div className="content">
							...
							<div className="feature">
								<div className="icon">
									<img src={"https://cdn.visionrp.fr/vision-cdn-v1/SubPremium/icons/car_plate.webp"} alt="" />
								</div>
								<div className="content">
							...
							<div className="feature">
								<div className="icon">
									<img src={"https://cdn.visionrp.fr/vision-cdn-v1/SubPremium/icons/shirts.webp"} alt="" />
								</div>
								<div className="content">
					...
					<div className="cards">
						<div className="card" onClick={() => postAsync("openCustomBoutique")}>
							<div className="icon">
								<img src={"https://cdn.visionrp.fr/vision-cdn-v1/SubPremium/clothes.webp"} alt="" />
							</div>
							<div className="content">
								<div className="features">
									<div className="feature">
						...
						<div className="card" onClick={() => changeWebview("BoutiqueVehicules")}>
							<div className="icon">
								<img src={"https://cdn.visionrp.fr/vision-cdn-v1/SubPremium/cars.webp"} alt="" />
							</div>
							<div className="content">
								<div className="features">
									<div className="feature">
						...
						<button
							onClick={() => {
								...
								(window as any).invokeNative
									? (window as any).invokeNative("openUrl", "https://visionboutique.tebex.io/package/6219102")
									: window.open("https://visionboutique.tebex.io/package/6219102");
							}}>
							S'abonner
						</button>
						<p>
