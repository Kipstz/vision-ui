			...
			<div className="atm_wallet_container">
										...
										<div className="d-flex justify-content-between">
											...
											<div className="d-flex flex-column align-items-center">
												<img
													...
													src="https://cdn.visionrp.fr/vision-cdn-v1/atm/nfc.webp"
													alt="NFC icon"
												/>
												<img
													className="atm_wallet_card_puce"
													src="https://cdn.visionrp.fr/vision-cdn-v1/atm/puce.webp"
													alt="NFC icon"
												/>
											</div>
										</div>
				...
				<div className="atm_wallet_next d-flex justify-content-center align-items-center">
					<button className="btn" onClick={next}>
						<span>Choisir</span>
						<img src="https://cdn.visionrp.fr/vision-cdn-v1/atm/arrow.webp" alt="Arrow icon" />
					</button>
				</div>
			</div>
		</div>
