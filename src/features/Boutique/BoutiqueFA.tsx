					...
					<div className="MainContent">
						...
						<div className="Nav">
							<div
								...
								<img src="https://cdn.visionrp.fr/vision-cdn-v1/Boutique/Group_581.webp" className="Bg" />
							...
							<div
								...
								<img src="https://cdn.visionrp.fr/vision-cdn-v1/Boutique/Group_580.webp" className="Bg" />
								<div className="Name middle" style={{ textAlign: "center" }}>
									PREMIUM <span>+</span>
								</div>
							</div>
							<div
								className={`Element disabled  ${selectedElement == 2 ? "active" : ""}`}
								// onClick={() => {
								// 	isDev
								...
								// }}
							>
								<img src="https://cdn.visionrp.fr/vision-cdn-v1/Boutique/veh_disbaled_fa.webp" className="Bg" />
								{/*Désactivation boutique*/}
								{/*<img src="https://cdn.visionrp.fr/vision-cdn-v1/Boutique/vah.webp" className="Bg" />*/}
								{/*<div className="Name" style={{ textAlign: "center" }}>*/}
								{/*	VEHICULES*/}
								{/*</div>*/}
							</div>
						...
						<div className="Nav">
							<div className="Left">
								<div
									...
									<img src={`https://cdn.visionrp.fr/vision-cdn-v1/Boutique/vet-cu_${sex}.webp`} className="Bg" />
								...
								<div
									...
									<img src={`https://cdn.visionrp.fr/vision-cdn-v1/Boutique/bij-cu_${sex}.webp`} className="Bg" />
									<div className="Name Lg" style={{ textAlign: "right" }}>
										BIJOUX
									</div>
									<div className="SubName Lg" style={{ textAlign: "right" }}>
							...
							<div className="Center">
								<div
									...
									<img src={`https://cdn.visionrp.fr/vision-cdn-v1/Boutique/mas_${sex}.webp`} className="Bg" />
								...
								<div
									...
									<img src={`https://cdn.visionrp.fr/vision-cdn-v1/Boutique/tat_sex.webp`} className="Bg" />
							...
							<div className="Right">
								<div
									...
									<img src={`https://cdn.visionrp.fr/vision-cdn-v1/Boutique/voit-cu_${sex}.webp`} className="Bg" />
									<div className="Name" style={{ textAlign: "right" }}>
										VÉHICULES
									</div>
									<div className="SubName" style={{ textAlign: "right" }}>
								...
								<div
									...
									<img src={`https://cdn.visionrp.fr/vision-cdn-v1/Boutique/boutique.webp`} className="Bg" />
									<div className="Name" style={{ textAlign: "right" }}>
										BOUTIQUE
									</div>
									<div className="SubName" style={{ textAlign: "right" }}>
